...
def split_dataset(conf):
  current_dir = "{}yolo_training/data/museum/images".format(conf['yolo_training']) # "./data/museum/images"
  split_pct = 10  # 10% validation set
  file_train = open("yolo_training/data/museum/train.txt", "w")
  file_val = open("yolo_training/data/museum/val.txt", "w")
  counter = 1
