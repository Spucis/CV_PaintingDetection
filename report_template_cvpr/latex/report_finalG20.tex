...
website to improve the retrival and rectification tasks. We added 18 paintings that are named 
with a fixed suffix "A" followed by a zero-based sequential identifier, \eg "A001.jpg".
...
Parlare di altri paper che trattano di questo problema

\section{Approach}

Suddividere in varie sezioni:\\
- Painting Detection:\\
	- Edge Detection\\
	- CCL\\
	- ROI Clean rules\\
...
- People Detection\\
- Statue Detection and Segmentation
