...
\begin{figure}
    \centering
    \subfloat[Original frame]{\includegraphics[width=0.5\linewidth]{frame.jpg}}\\
    \subfloat[Canny edge detection]{\includegraphics[width=0.5\linewidth]{canny_out.jpg}}\\
    \subfloat[Closing results]{\includegraphics[width=0.5\linewidth]{closing_canny.jpg}}\\
    \subfloat[Detected connected components]{\includegraphics[width=0.5\linewidth]{connected_components.jpg}}\\
    \subfloat[Connected components ROIs]{\includegraphics[width=0.5\linewidth]{components_rois.jpg}}\\
    \subfloat[Relevant ROIs; in green the discarded ROIs due to the overlap]{\includegraphics[width=0.5\linewidth]{relevant_rois.jpg}}
