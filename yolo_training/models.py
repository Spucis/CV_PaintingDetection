...
from yolo_training.utils.utils import build_targets
...
"""
        ...
        y_true: labels -> shape (B, numBB, 5) (float)   shape[2] = [class, cx, cy, w, h]
...
def eval_acc(model: nn.Module, data_loader: torch.utils.data.DataLoader,
    ...
    with torch.no_grad():
        for _, (_, x, y) in enumerate(data_loader):
